...
export default function MenuToggler({ toggle }) {
  return (
    <button
      className="flex justify-center items-center bg-slate-100 transition-all duration-500 dark:bg-cyan-500 z-50 border-0 outline-none focus:outline-none absolute top-[17px] left-[29px] w-[50px] h-[50px] rounded-full"
      onClick={toggle}
    >
